...
<div class="content">
    ...
    <div class="contact-box">
        <h3>Γραμματεία:</h3>
        <p class="main-no-indent">Βασίλης Ασημακόπουλος: <a href="mailto:asimakv@yahoo.gr">asimakv@yahoo.gr</a> <br>
        Δημήτρης Δεληολάνης: <a href="mailto:deliolanes@libero.it" >deliolanes@libero.it</a> </p>
      </div>

    <div class="contact-box">
        <h3>Συντακτική Επιτροπή:</h3>
        <p class="main-no-indent">Μανόλης Αγγελίδης (†2018), Λουκάς Αξελός, Απόστολος Αποστολόπουλος, Βασίλης Ασημακόπουλος, Κώστας Βενιζέλος, Δημήτρης Δεληολάνης, Σταύρος Λυγερός, Δημήτρης Μπελαντής, Ηλίας Ι. Νικολόπουλος, Πέτρος Παπαπολυβίου, Ρούντι Ρινάλντι</p>
      </div>
    ...
    <div class="contact-box">
      <p class="main-no-indent">• Κάθε ενυπόγραφο άρθρο εκφράζει την προσωπική άποψη του συγγραφέα • Τα κείμενα που στέλνονται στο περιοδικό για δημοσίευση πρέπει απαραίτητα να είναι σε ηλεκτρονική μορφή και αυστηρά έως 4.000 λέξεις, εκτός και αν έχει συμφωνηθεί διαφορετικά • Τα κείμενα οφείλουν να είναι ενυπόγραφα και να συνοδεύονται από την διεύθυνση και το επάγγελμα του αποστολέα • Τα κείμενα που στέλνονται στο περιοδικό για δημοσίευση κρίνονται από κριτές που ορίζει η Σ.Ε., χωρίς να γνωστοποιεί τα ονόματα των κρινόμενων συγγραφέων • Τα αποστελλόμενα κείμενα δεν επιστρέφονται</p>
    </div>
    ...
    <div class="contact-box">
      <p class="main-no-indent">Οι καταχωρήσεις τρίτων στο περιοδικό δεν έχουν εμπορικό χαρακτήρα</p>
    </div>


    <div class="contact-box">
      <p class="main-no-indent">Κεντρική διάθεση, παλιότερα τεύχη και συνδρομές: <a href="http://www.stochastis.gr">Εκδόσεις Στοχαστής</a></p>
    </div>
