...
<?php get_header() ?>
      ...
      <div class="content">
          ...
          <h1 class="text-centered space-below">Αρχείο τευχών</h1>
          <p class="shown-always space-below"> Αναζητήστε τα περιεχόμενα των τευχών που σας ενδιαφέρουν. Σε ολοκληρωμένη ψηφιακή μορφή είναι διαθέσιμα μέχρι στιγμής τα τεύχη 66-67, 68-69 και 70-71. Ακολουθήστε μας στο <a href="https://www.facebook.com/Τετράδια-Πολιτικού-Διαλόγου-Έρευνας-και-Κριτικής-250982335013524/">Facebook</a> για να παραμένετε ενημερωμένοι για τις μελλοντικές αναρτήσεις.</p>
