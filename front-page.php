...
We use two deparate queries: one for the left column, to fetch the image and category link and a second one for the right column to fetch the last issues contents
-->
